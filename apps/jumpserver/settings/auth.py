...
AUTH_LDAP_CACERT_CONTENT = CONFIG.AUTH_LDAP_CACERT_CONTENT
AUTH_LDAP_CERT_CONTENT = CONFIG.AUTH_LDAP_CERT_CONTENT
AUTH_LDAP_KEY_CONTENT = CONFIG.AUTH_LDAP_KEY_CONTENT
AUTH_LDAP_USER_ATTR_MAP = CONFIG.AUTH_LDAP_USER_ATTR_MAP
AUTH_LDAP_USER_QUERY_FIELD = 'username'
AUTH_LDAP_GLOBAL_OPTIONS = LDAPTLSUtil('ldap').build_global_options()
...
AUTH_LDAP_HA_CACERT_CONTENT = CONFIG.AUTH_LDAP_HA_CACERT_CONTENT
AUTH_LDAP_HA_CERT_CONTENT = CONFIG.AUTH_LDAP_HA_CERT_CONTENT
AUTH_LDAP_HA_KEY_CONTENT = CONFIG.AUTH_LDAP_HA_KEY_CONTENT
AUTH_LDAP_HA_USER_ATTR_MAP = CONFIG.AUTH_LDAP_HA_USER_ATTR_MAP
AUTH_LDAP_HA_USER_QUERY_FIELD = 'username'
AUTH_LDAP_HA_GLOBAL_OPTIONS = LDAPTLSUtil('ldap_ha').build_global_options()
...
AUTH_OPENID_KEYCLOAK = CONFIG.AUTH_OPENID_KEYCLOAK
